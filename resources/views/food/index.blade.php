...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="align-content-right"><a href="{{route('food.create')}}"><button class="btn btn-outline-success">+ Add New Food</button></a></div><br>
                                                    ...
                                                    <form action="{{route('food.destroy', [$food->id])}}" method="POST">@csrf
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                Are you sure to Delete? <br> {{$food->name}}
                                                            </div>
